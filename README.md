...
This enhanced version includes support for LM Studio, allowing you to use local models through LM Studio's OpenAI-compatible API.
...
### Features
- **74+ Model Support**: Auto-discovery of available LM Studio models
- **Dynamic Model Selection**: Choose specific models or use default
- **Connection Testing**: Built-in diagnostics and validation
- **OpenAI-Compatible**: Uses standard API client for communication
